        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: UIHelper().verticalSpaceLarge(context) ,),
              Column(
                ...
                children: [
                  ...
                  Container(
                    height: UIHelper().displayHeight(context) * 0.4,
                    width: UIHelper().displayWidth(context) * 0.4,
                    decoration:
                        BoxDecoration(border: Border.all(color: Colors.grey)),
                    child: Center(child: Text("Drag & Drop"),),
                  )
                ],
              ),
              SizedBox(
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Center(child: Text("Hochladen", style: kButtonTextStyle,),),
                  )
