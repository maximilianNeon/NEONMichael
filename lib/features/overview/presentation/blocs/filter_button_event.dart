...
class FilterButtonEvent with _$FilterButtonEvent {
  ...
  const factory FilterButtonEvent.filterButtonEventType() = _FilterButtonEventType;
  const factory FilterButtonEvent.filterButtonEventPattern() = _FilterButtonEventPattern;
  const factory FilterButtonEvent.filterButtonEventElement() = _FilterButtonEventElement;
